     ...
     <header className="text-white d-flex align-items-center"style={{ backgroundImage: `url(${headerimage})`, backgroundSize: "cover", backgroundPosition: "center", height: "500px", position: "relative",}}>
          ...
          <div className="container" style={{ position: "relative", zIndex: 2 }}>
            <div className="col-md-8">
              ...
              <a href="/products" className="btn btn-primary"  style={{ backgroundColor: "#fd7e14", color: "white" , border: "2px solid #fd7e14",}}>
                Explore Now
              </a>
            </div>
          </div>
          ...
          {/* <section className="mb-5">
           ...
           <section className="mb-5">
             ...
             <div className="row">
               ...
               <div className="col-md-4 mb-4">
                 <div className="card h-100 shadow">
                   <img src="/images/leather.jpg" className="card-img-top" alt="Leather" />
                   <div className="card-body">
               ...
               <div className="col-md-4 mb-4">
                 <div className="card h-100 shadow">
                   <img src="/images/wool.jpg" className="card-img-top" alt="Wool" />
                   <div className="card-body">
               ...
               <div className="col-md-4 mb-4">
                 <div className="card h-100 shadow">
                   <img src="/images/dyes.jpg" className="card-img-top" alt="Natural Dyes" />
                   <div className="card-body">
